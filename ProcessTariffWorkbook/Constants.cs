...
namespace ProcessTariffWorkbook
{
  ...
  {        
    ...
    public const string SpecialCountries = "ITALY VATICAN CITY,PORTUGAL AZORES,PORTUGAL MADEIRA,SPAIN BALEARIC ISLANDS,SPAIN CANARY ISLANDS,SPAIN CEUTA AND MELILLA,UNITED STATES ALASKA,UNITED STATES HAWAII,CYPRUS NORTH"; // comma seperated
  }
}
