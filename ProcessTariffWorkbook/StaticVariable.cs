...
namespace ProcessTariffWorkbook
{
  ...
  {       
    ...
    public static List<string> PrefixesMatchedByRegEx = new List<string>();
    public static List<string> PrefixNumbersFromIniFiles = new List<string>();
    ...
    public static string CategoryMatrixXlsxFile = string.Empty;
