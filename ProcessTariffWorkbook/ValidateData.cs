  ...
  public static class ValidateData
  {
    ...
    public static void CheckForCommasInLine(string sComma)
    {
      if (sComma.Contains(","))
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "There is a comma in the file. No commas are allowed.");
      ...
      foreach (var tok in query)
      {
        if (tok.ChargingType.ToUpper().Equals(Constants.Duration))
        {
          ...
          try
          {
            foreach (string price in resultsList)
            {
              ...
              StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                                 "Duration: One of the prices is not a double. ");
        ...
        else if (tok.ChargingType.ToUpper().Equals(Constants.Capped))
        {
          ...
          if (!double.TryParse(tok.CustomerFirstInitialRate, out parsedDoubleValue))
          {
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckPricesAreInCorrectFormat()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Capped: Capped Price per minute is not in correct format. it must be a double: " +
                                               tok.CustomerFirstInitialRate);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Capped: If there are no capped prices, delete the capped worksheet");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          if (!double.TryParse(tok.CustomerFirstSubseqRate, out parsedDoubleValue))
          {
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckPricesAreInCorrectFormat()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Capped: Capped Price is not in correct format. it must be a double: " +
                                               tok.CustomerFirstSubseqRate);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Capped: If there are no capped prices, delete the capped worksheet");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          if (!int.TryParse(tok.CustomerSecondInitialRate, out parsedIntValue))
          {
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckPricesAreInCorrectFormat()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Capped: Capped Time is not in correct format. it must be a int. time in minutes: " +
                                               tok.CustomerSecondInitialRate);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Capped: If there are no capped prices, delete the capped worksheet");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          if (!double.TryParse(tok.CustomerMinCharge, out parsedDoubleValue))
          {
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckPricesAreInCorrectFormat()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Capped: Capped Minimum Cost is not in correct format. it must be a double. " +
                                               tok.CustomerMinCharge);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Capped: If there are no capped prices, delete the capped worksheet");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          if (!double.TryParse(tok.CustomerConnectionCost, out parsedDoubleValue))
          {
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckPricesAreInCorrectFormat()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Capped: Capped Connection Cost is not in correct format. it must be a double. " +
                                               tok.CustomerConnectionCost);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Capped: If there are no capped prices, delete the capped worksheet");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
        ...
        else if (tok.ChargingType.ToUpper().Equals(Constants.Pulse))
        {
          ...
          if (!int.TryParse(tok.CustomerFirstInitialRate, out parsedIntValue))
          {
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckPricesAreInCorrectFormat()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Pulse: Pulse Length given in decimal format must be multipled by 100. it must be changed to an int: " +
                                               tok.CustomerFirstInitialRate);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Pulse: If there are no Pulse prices, delete the Pulse worksheet");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          if (parsedIntValue / 100 < minimumPulseLength)
          {
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckPricesAreInCorrectFormat()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "Pulse: Pulse Length is too short: " +
                                               tok.CustomerFirstInitialRate);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "It may not have been multipled by 100. It must be changed to an int from a decimal: ");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Pulse: If there are no Pulse prices, delete the Pulse worksheet");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          if (!int.TryParse(tok.CustomerFirstSubseqRate, out parsedIntValue))
          {
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckPricesAreInCorrectFormat()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Pulse: Pulse Unit is not in correct format. it must be a int, normally 1: " +
                                               tok.CustomerFirstSubseqRate);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Pulse: If there are no Pulse prices, delete the Pulse worksheet");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          ...
          if (!double.TryParse(tok.CustomerMinCharge, out parsedDoubleValue))
          {
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckPricesAreInCorrectFormat()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Pulse: Minimum Cost is not in correct format. it must be a double: " +
                                               tok.CustomerMinCharge);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Pulse: If there are no Pulse prices, delete the Pulse worksheet");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          ...
          if (!double.TryParse(tok.CustomerConnectionCost, out parsedDoubleValue))
          {
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckPricesAreInCorrectFormat()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Pulse: Connection Cost is not in correct format. it must be a double: " +
                                               tok.CustomerConnectionCost);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Pulse: If there are no Pulse prices, delete the Pulse worksheet");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
    ...
    private static void CheckForDestinationTypes()
    {
      ...
      if (StaticVariable.ExportNdsValue.ToUpper().Equals("TRUE"))
      {
        ...
        if (query.Any())
        {
          ...
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                             "This destination type is invalid for V5 RingMaster. ");
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                             "It must be either 'Local', 'National', International', 'International Mobile', 'Mobile', 'Services' or 'Other'");
          foreach (var item in query)
          {
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "The offending destinationan type is - " +
                                               item.CustomerDestinationType + " and Customer  name is - " +
                                               item.CustomerPrefixName);
          }
          StaticVariable.ProgressDetails.Add(Environment.NewLine + Constants.FiveSpacesPadding +
                                             "Comment out 'ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();' in method to supress killing program");
          ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
        }
      }
    ...
    private static void CheckTablesForDefaultValue()
    {
      ...
      if (extraTablesInPrefixes.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "A default prefix name (e.g Local,?) does not have a entry (e.g. " +
                                           StaticVariable.CountryCodeValue +
                                           "_Local) in prefix links header. \nIs the prefix file missing?");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "Check if the name spelt correctly or is there an INI file that is not required?");
        foreach (var item in extraTablesInPrefixes)
        {
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "The offending entry is " + item);
        }
        //ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
      }
      if (extraTablesInTableLinks.Any())
      {
        StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckTablesForDefaultValue()");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "A table in prefix links header does not have a default prefix in its corresponding table. ");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "E.g The Prefix Links has an entry for " +
                                           StaticVariable.CountryCodeValue +
                                           "_Local but it does not have a default entry (e.g. Local,?) in the " +
                                           StaticVariable.CountryCodeValue + "_Local table");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "Check if the name spelt correctly or an ini file may be missing for that prefix link.");
    ...
    private static void CheckRoundingForIncorrectEntry()
    {
      ...
      try
      {
        ...
        if (errors.Any())
        {
          ...
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                             "The Rounding Values are incorrect for these destinations.");
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                             "The must be 'Yes', 'Y', 'ROUND UP', 'ROUNDUP' or '1' for round up and 'No', 'N', 'EXACT', 'NOROUND', 'NO ROUND' or '3' for no round");
    ...
    private static void CheckTimeSchemeForIncorrectEntry()
    {
      ...
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                       "CheckTimeSchemeForIncorrectEntry() -- started");
      List<string> errors = new List<string>();
      ...
      if (errors.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "The Time Scheme Values are incorrect for these destinations.");
        foreach (string error in errors)
        {
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + error);
        }
      ...
      Console.WriteLine("ValidateData".PadRight(30, '.') + "CheckRounding() -- finished");
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                       "CheckTimeSchemeForIncorrectEntry() -- finished");
    }
    ...
    private static void CheckIfMinCostAndRate4SubseqAreSame()
    {
      ...
      var query =
        ...
        where
        drm.CustomerFourthSubseqRate.Equals(drm.CustomerMinCharge) && Convert.ToDouble(drm.CustomerMinCharge) > 0.0
        select new {drm.CustomerPrefixName, drm.CustomerMinCharge, drm.CustomerFourthSubseqRate};

      foreach (var q in query)
      {
        pricesTheSame.Add(q.CustomerPrefixName + ": MinCost = " + q.CustomerMinCharge + ", 4th Rate Subsequential = " +
                          q.CustomerFourthSubseqRate);
      }
      if (pricesTheSame.Any())
      {
        pricesTheSame.Sort();
        StaticVariable.ProgressDetails.Add(Environment.NewLine +
                                           "Minimum Cost is the same price as the 4th Rate Subsequent price. Check it out.");
    ...
    private static void CheckIfFreephoneIsFree()
    {
      ...
      var results =
        ...
        /*&&
                      !db.CustomerPrefixName.ToUpper().Contains("INT") && !db.StdPrefixName.ToUpper().Contains("INT")*/
        select new
        {
      ...
      if (NonZeroFreeCalls.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "The destinations below may or may not be free calls.");
    ...
    private static void CheckGrouping()
    {
      ...
      var queryUsingGroupBands =
        from DataRecord db in StaticVariable.CustomerDetailsDataRecord
        where
        !db.CustomerUsingGroupBands.ToUpper().Equals("TRUE") && !db.CustomerUsingGroupBands.ToUpper().Equals("FALSE")
      ...
      if (usingGroupBands.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "The Using Group Bands field are incorrect for these destinations.");
      ...
      {
        if (q.CustomerGroupBand.Length > Constants.V5Tc2BandLengthLimit &&
            StaticVariable.ExportNdsValue.ToUpper().Equals("TRUE") && q.CustomerUsingGroupBands.Equals("TRUE"))
        {
      ...
      if (groupBands.Any())
      {
        StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckGrouping()");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "The Group Band field are too long for these destinations.");
      ...
      if (groupBandDescriptions.Any())
      {
        StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckGrouping()");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "The Group Band Description field are too long for these destinations.");
    ...
    public static void CheckIntervalLengthsGreaterOrEqualToZero()
    {
      ...
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                       "CheckIntervalLengthsGreaterOrEqualToZero() -- started");
      ...
      if (errors.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "One or more of the interval lengths is not an integer or is less than 1. ");
        foreach (string error in errors)
        {
          ...
          foreach (var q in query)
          {
            ...
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + Constants.FiveSpacesPadding +
                                               "initial interval Length    = " + q.CustomerInitialIntervalLength);
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + Constants.FiveSpacesPadding +
                                               "subsequent interval length = " + q.CustomerSubsequentIntervalLength);
          }
        }
        ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
      }
      ...
      if (queryIntervalLengthValues.Any())
      {
        StaticVariable.ProgressDetails.Add(Environment.NewLine +
                                           "ValidateData::CheckIntervalLengthsGreaterOrEqualToZero()");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "The interval lengths listed below are not the default 60 seconds. ");
        ...
        foreach (var interval in queryIntervalLengthValues)
        {
          ...
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + Constants.FiveSpacesPadding +
                                             "initial interval Length    = " + interval.CustomerInitialIntervalLength);
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + Constants.FiveSpacesPadding +
                                             "subsequent interval length = " + interval.CustomerSubsequentIntervalLength);
        }
      }
      Console.WriteLine("ValidateData".PadRight(30, '.') + "CheckIntervalLengthsGreaterOrEqualToZero() -- finished");
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                       "CheckIntervalLengthsGreaterOrEqualToZero() -- finished");
    }
    ...
    public static void CheckUsingCustomerNames()
    {
      ...
      if (query.Any())
      {
        ...
        foreach (var tok in query)
        {
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + tok.CustomerPrefixName + " : " +
                                             tok.CustomerUsingCustomerNames);
        }
        ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
      }
    ...
    public static void CheckMinimumIntervals()
    {
      ...
      if (errList.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "One of the interval lengths is not an integer. ");
    ...
    public static void CheckMinimumDigits()
    {
      ...
      if (errList.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "One of the minimum digits is not an integer or is less than zero. ");
        foreach (string token in errList)
        {
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + token);
        }
    ...
    public static void CheckCutOffDuration()
    {
      ...
      if (errList.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "One of the Cut-Off values is not an integer or is less than zero. ");
        foreach (string token in errList)
        {
    ...
    public static void CheckDialTime()
    {
      ...
      if (errList.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "One of the Dial Time values is not an integer or is less than zero. ");
        foreach (string token in errList)
        {
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + " --> " + token);
        }
    ...
    {
      Console.WriteLine("ValidateData".PadRight(30, '.') +
                        "CheckIntervalsAtInitialCostGreaterOrEqualToZero() -- started");
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                       "CheckIntervalsAtInitialCostGreaterOrEqualToZero() -- started");
      List<string> errList = new List<string>();
      ...
      {
        StaticVariable.ProgressDetails.Add(Environment.NewLine +
                                           "ValidateData::CheckIntervalsAtInitialCostGreaterOrEqualToZero()");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "Intervals At Initial Cost is not an integer or is less than zero. ");
        foreach (string token in errList)
        {
          var errQuery =
          ...
          {
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + error.CustomerPrefixName + " : " +
                                               error.CustomerIntervalsAtInitialCost);
          }
        }
        ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
      }
      Console.WriteLine("ValidateData".PadRight(30, '.') +
                        "CheckIntervalsAtInitialCostGreaterOrEqualToZero() -- finished");
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                       "CheckIntervalsAtInitialCostGreaterOrEqualToZero() -- finished");
    }
    ...
    public static void CheckTableNames()
    {
      ...
      if (queryTableName.Any())
      {
        ...
        {
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + table.CustomerPrefixName + " : " +
    ...
    public static void CheckDestinationTypesNames()
    {
      ...
      if (query.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "Destination types that don't match the V5 default ones of 'Local', 'National', International', International Mobile', 'Mobile', 'Services' & 'Other'");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "If the tariff is for V6 (TDI) then these default destination types are irrelevant");
        foreach (var q in query)
        {
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + q.CustomerPrefixName + " : " +
                                             q.CustomerDestinationType);
        }
      }
    ...
    public static void CheckForMoreThanTwoRegExFiles()
    {
      ...
      if (!count.Equals(1))
      {
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "There can only be ONE RegEx file in the " +
                                           StaticVariable.DatasetsFolder);
      ...
      {
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "There can only be ONE RegEx file in the " +
                                           StaticVariable.DatasetFolderToUse);
    ...
    private static void CheckForNonMatchingNames()
    {
      ...
      if (queryNames.Any())
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "Std RegEx Names that don't match the Client Names exactly");
        foreach (var names in queryNames)
        {
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + names.StdPrefixName.PadRight(44, '.') + " : " +
                                             names.CustomerPrefixName);
        }
      }
    ...
    {
      Console.WriteLine("ValidateData".PadRight(30, '.') +
                        "CheckSourceDestinationBandsPresentInPrefixBands() -- started");
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                       "CheckSourceDestinationBandsPresentInPrefixBands() -- started");
      ...
      List<string> uniqueSourceDestinations =
        StaticVariable.SourceDestinationBands.Select(sdb => sdb.Split('\t'))
          .Select(sourceDestinationAry => sourceDestinationAry[sourceDestinationBand])
          .ToList();
      ...
      {
        StaticVariable.ProgressDetails.Add(Environment.NewLine +
                                           "ValidateData:CheckSourceDestinationBandsPresentInPrefixBands()");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "There is a Source Destination band in header file that is not found in spreadsheet.");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "You may be missing an spreadsheet entry for 'Local', 'National' or 'Regional'?");
      ...
      Console.WriteLine("ValidateData".PadRight(30, '.') +
                        "CheckSourceDestinationBandsPresentInPrefixBands() -- finished");
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                       "CheckSourceDestinationBandsPresentInPrefixBands() -- finished");
    }
    ...
    public static string AdjustRoundingValueForV6Twb(string value)
    {
          ...
          value.ToLower().Equals("roundup") || value.ToLower().Equals("round up"))
      {
        result = "YES";
               ...
               value.ToLower().Equals("no round") || value.ToLower().Equals("noround") || value.ToLower().Equals("exact"))
      {
        result = "NO";
      }
      else
    ...
    private static void CheckIfAllMatrixBandsUsed()
    {
      ...
      foreach (var hSet in sourceDestinationBands)
      {
        ...
        if (!found)
        {
          ...
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "The matrix band - " + hSet +
                                             " was not found");
          ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
        }
      }
    ...
    private static void CheckChargingType()
    {
      ...
      foreach (var type in queryChargingTypes)
      {
        ...
        if (!found)
        {
          ...
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                             "It must be either Duration, Capped or Pulse, not: " + type);
          ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
        }
        found = false;
      }
      ...
      else
      {
        ...
        foreach (string tok in StaticVariable.TariffPlan)
        {
          ...
          catch (Exception e)
          {
            ...
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "CheckTariffPlanList: Name \t Value must be tab seperated");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + e.Message);
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          switch (name.ToUpper())
          {
            case Constants.TariffPlanName:
              ...
              {
                StaticVariable.ProgressDetails.Add("ValidateData::CheckTariffPlanList()");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "CheckTariffPlanList: Tariff Plan Value Column has no entry. It must have a value.");
              ...
              else
              {
                ...
                StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + name.PadRight(26, ' ') + " = " + StaticVariable.TariffPlanNameValue);
              }
              break;
            ...
            case Constants.ReleaseDate:
              ...
              else
              {
                ...
                StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + name.PadRight(26, ' ') + " = " + StaticVariable.ReleaseDateValue);
              }
              break;
            case Constants.EffectiveFrom:
              ...
              {
                StaticVariable.ProgressDetails.Add("ValidateData::CheckTariffPlanList()");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "CheckTariffPlanList: Effective From Date Value Column has no entry. It must have a value.");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "Name\t\tValue");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + name + "  ?");
                ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
              }
            ...
            case Constants.Country:
              ...
              {
                StaticVariable.ProgressDetails.Add("ValidateData::CheckTariffPlanList()");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "CheckTariffPlanList: Country Value Column has no entry. It must have a value.");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "Name\t\tValue");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + name + "  ?");
                ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
              }
              else
              {
                ...
                StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + name.PadRight(26, ' ') + " = " + StaticVariable.CountryValue);
              }
              break;
            case Constants.CountryCode:
              ...
              {
                StaticVariable.ProgressDetails.Add("ValidateData::CheckTariffPlanList()");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +  "CheckTariffPlanList: Country Code Value Column has an incorrect entry. It must have a integer value.");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "Name\t\tValue");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + name + " : " + value);
                ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
              }
              else
              {
                ...
                StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + name.PadRight(26, ' ') + " = " + StaticVariable.CountryCodeValue);
              }
              break;
            case Constants.CurrencyIsoCode:
              ...
              {
                StaticVariable.ProgressDetails.Add("ValidateData::CheckTariffPlanList()");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "CheckTariffPlanList: Currency (ISOCode) Value Column has an incorrect entry. It must be an integer value.");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "Name\t\tValue");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + name + " : " + value);
                ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
              }
            ...
            case Constants.StartingPointTableName:
              ...
              {
                StaticVariable.ProgressDetails.Add("ValidateData::CheckTariffPlanList()");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "CheckTariffPlanList: Starting Point Table Value Column has no entry. It must have a value.");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "Name\t\tValue");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + name + "  ?");
                ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
              }
            ...
            case Constants.IsPrivate:
              ...
              {
                StaticVariable.ProgressDetails.Add("ValidateData::CheckTariffPlanList()");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "CheckTariffPlanList: Is Private Value Column has no entry. It must have a value.");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "Name\t\tValue");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + name + "  ?");
                ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
              }
            ...
            case Constants.Rate1:
              ...
              {
                StaticVariable.ProgressDetails.Add("ValidateData::CheckTariffPlanList()");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "CheckTariffPlanList: Rate 1 Value Column has no entry. It must have a value.");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "Name\t\tValue");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + name + "  ?");
                ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
              }
            ...
            case Constants.TariffReferenceNumber:
              ...
              else
              {
                ...
                else
                {
                  ...
                  StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + name.PadRight(26, ' ') + " = " + StaticVariable.TariffReferenceNumberValue);
                }
              }
              break;
            ...
            case Constants.Version:
              ...
              else
              {
                ...
                StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + name.PadRight(26, ' ') + " = " + StaticVariable.VersionValue);
              }
              break;
            case Constants.ExportNds:
              ...
              else
              {
                ...
                StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + name.PadRight(26, ' ') + " = " + StaticVariable.ExportNdsValue);
              }
              break;
            case Constants.CarrierUnitPrice:
              ...
              StaticVariable.CarrierUnitPriceValue = value;
              StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + name.PadRight(26, ' ') + " = " + StaticVariable.CarrierUnitPriceValue + " : If pulse is not being used, delete Carrier Unit Price in TWB header file & delete pulse work sheet.");                           
              break;
    ...
    private static void GetHolidaysIntoList(string value)
    {
      ...
      foreach (string tok in differentHolidays)
      {
        ...
        if (differentDates[0].Length.Equals(2) && differentDates[1].Length.Equals(3) &&
            differentDates[2].Length.Equals(4))
        {
        ...
        else
        {
          ...
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                             "The holidays are not in the correct format. They must be like so: DD-Mmm-YYYY.");
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                             "Check for additional white space. dates must be comma seperated");
          StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + tok);
          ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
        }
      }
    ...
    public static void CheckTableLinksList()
    {
      ...
      else
      {
        ...
        StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + "Table Name".PadRight(23, ' ') +
        ...
        foreach (string tok in StaticVariable.TableLinks)
        {
          ...
          for (int i = 0; i < numberOfTableLinksColumns; i++)
          {
            ...
            {
              if (aryLine[passPrefix].ToUpper().Equals("NO") || aryLine[passPrefix].ToUpper().Equals("YES")) continue;
              StaticVariable.ProgressDetails.Add("ValidateData::CheckTableLinksList()");
              StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
          ...
          StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + aryLine[tableName].PadRight(23, ' ') +
                                       aryLine[prefix].PadRight(9, ' ') + aryLine[passPrefix].PadRight(19, ' ') +
                                       aryLine[destination]);
        }
      }
    ...
    public static void CheckTimeSchemesList()
    {
      ...
      if (StaticVariable.TimeSchemes.Count.Equals(0))
      {
        ...
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + StaticVariable.XlsxFileName +
                                           "CheckTimeSchemesList is empty");
        ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
      }
      else
      {
        ...
        foreach (string tok in StaticVariable.TimeSchemes)
        {
          ...
          if (!aryLine.Length.Equals(numberOfColumns))
          {
            StaticVariable.ProgressDetails.Add("ValidateData::CheckTimeSchemesList()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "Time Schemes has an incorrect entry. There should be 3 columns");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + tok);
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          for (int i = 0; i < numberOfColumns; i++)
          {
            if (string.IsNullOrEmpty(aryLine[i]))
            {
              StaticVariable.ProgressDetails.Add("ValidateData::CheckTimeSchemesList()");
              StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                                 "Time Schemes has an incorrect entry. One of the columns is empty");
              StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + aryLine[i]);
              ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
            }
          }
          StaticVariable.TimeSchemesNames.Add(aryLine[schemeName]);
          StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + aryLine[schemeName].PadRight(19, ' ') +
                                       aryLine[holidaysRelevant].PadRight(24, ' ') + aryLine[defaultRate]);
        }
      }
    ...
    public static void CheckTimeSchemeExceptionsList()
    {
      ...
      StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + "Time Scheme Name".PadRight(19, ' ') +
                                   "Day".PadRight(5, ' ') + "Start".PadRight(11, ' ') + "Finish".PadRight(11, ' ') +
                                   "Rate");
      ...
      foreach (string name in StaticVariable.TimeSchemesExceptions)
      {
        ...
        StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + lines[schemeName].PadRight(19, ' ') +
                                     lines[day].PadRight(5, ' ') + lines[start].PadRight(11, ' ') +
                                     lines[finish].PadRight(11, ' ') + lines[rate]);
      }
      ...
      foreach (string name in StaticVariable.TimeSchemesNames)
      {
        ...
        if (!bFound)
        {
          StaticVariable.TwbHeader.Add(Environment.NewLine + "The time scheme " + name +
                                       " was not defined in Time Scheme Exceptions. It does not need to be if only one rate (24/7) exists.");
        }
      }
      ...
      else
      {
        ...
        foreach (string tok in StaticVariable.Spelling)
        {
          ...
          if (string.IsNullOrEmpty(sValue))
          {
            StaticVariable.ProgressDetails.Add("ValidateData::CheckSpellingList()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "TITLE=SPELLING in Header files has a missing value for ");
          ...
          if (sName.ToUpper().Equals(Constants.InternationalMobileSpelling))
          {
            ...
            StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + "International Mobile Spelling".PadRight(29, ' ') + " = " + StaticVariable.InternationalMobileSpellingValue);
          }
          else if (sName.ToUpper().Equals(Constants.InternationalTableSpelling))
          {
            StaticVariable.InternationalTableSpellingValue = sValue;
            StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + "International Table Spelling".PadRight(29, ' ') + " = " + StaticVariable.InternationalTableSpellingValue);
          }
          else if (sName.ToUpper().Equals(Constants.NationalTableSpelling))
          {
            StaticVariable.NationalTableSpellingValue = sValue;
            StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + "National Table Spelling".PadRight(29, ' ') + " = " + StaticVariable.NationalTableSpellingValue);
          }
          else
          {
            StaticVariable.ProgressDetails.Add("ValidateData::CheckSpellingList()");
    ...
    public static void CheckSourceDestinationsBandList()
    {
      ...
      const int band = 3;
      const int table = 0;
      if ( /*!StaticVariable.SourceDestinationBands.Count.Equals(0)*/StaticVariable.SourceDestinationBands.Any())
      {
        StaticVariable.TwbHeader.Add(Environment.NewLine + "ValidateData::CheckSourceDestinationsBandList()");
        StaticVariable.TwbHeader.Add(Constants.FiveSpacesPadding + "SourceDestinationsBands: A Matrix is being used.");
        foreach (string tok in StaticVariable.SourceDestinationBands)
        {
          ...
          if (!matrixTokens.Length.Equals(numberOfColumns))
          {
            ...
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "The Source Destination (Matrix) columns are incorrect.");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "There must be " + numberOfColumns +
                                               " columns");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          if (matrixTokens[band].Length > Constants.TwbBandLengthLimit)
          {
            StaticVariable.ProgressDetails.Add("ValidateData::CheckSourceDestinationsBandList()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "The Source Destination (Matrix) band length is greater than " +
                                               Constants.TwbBandLengthLimit + ".");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "It must be no greater than " +
                                               Constants.TwbBandLengthLimit);
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          if (StaticVariable.ExportNdsValue.ToUpper().Equals("TRUE") &&
          ...
          {
            StaticVariable.ProgressDetails.Add("ValidateData::CheckSourceDestinationsBandList()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "The NDS band length is over " +
                                               Constants.V5Tc2BandLengthLimit + " characters limit.");
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
          foreach (string token in matrixTokens)
          {
            if (string.IsNullOrEmpty(token))
            {
              StaticVariable.ProgressDetails.Add("ValidateData::CheckSourceDestinationsBandList()");
              StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                                 "SourceDestinationsBands has an inncorrect number of columns. There should be " +
          ...
          if (!matrixTokens[table].ToUpper().Equals(StaticVariable.NationalTableSpellingValue.ToUpper()))
          {
            StaticVariable.ProgressDetails.Add("ValidateData::CheckSourceDestinationsBandList()");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                               "SourceDestinationsBands: The table name is not the national name. ");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + tok);
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
          }
        }
      ...
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                       "CheckSourceDestinationsBandList() -- finished");
    }
    ...
    public static void CheckForStdIntAndBandsFile()
    {
      ...
      if (!found)
      {
        StaticVariable.ProgressDetails.Add("ValidateData::CheckForStdIntAndBandsFile");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "There is no Std International Bands file in the dataset folder");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                           "It needs to be called - Std_Int_Names_Bands.txt");
        ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
      }
    ...
    private static void CheckForDuplicatePrefixNumbers()
    {
      Console.WriteLine("ValidateData".PadRight(30, '.') + "CheckForDuplicatePrefixNumbers() -- started");
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') + "CheckForDuplicatePrefixNumbers() -- started");
      ...
      if (duplicates.Any())
      {
        StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckForDuplicatePrefixNumbers()");
        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
        ...
        foreach (var dupe in duplicates)
        {
          ...
          {
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + num.PrefixNumber.PadRight(15, ' ') + " : " + num.PrefixName.PadRight(40, ' ') + " : " + num.TableName);
          }
        }
      }
      Console.WriteLine("ValidateData".PadRight(30, '.') + "CheckForDuplicatePrefixNumbers() -- finished");
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') + "CheckForDuplicatePrefixNumbers() -- finished");
    }
    ...
    private static void CheckForMissingDefaultEntries()
    {
      ...
      //var result = queryDefaultPrefixes.Join(numberOFTables, q => q.TableName, w => w, (q, w) => new {a = q.PrefixNumber, b = w});
      ...
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') + "CheckForMissingDefaultEntries() -- finished");
    }
    ...
    public static void CheckforAllTariffPlanEntries(string value)
    {
      ...
      /*if (!entryCount.Equals(numberOfRequiredEntries))
      {
        StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::CheckforAllTariffPlanEntries()");
