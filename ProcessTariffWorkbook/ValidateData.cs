...
namespace ProcessTariffWorkbook
{
    public static class ValidateData
    {
        ...
        public static void PostRegExMatchValidateCustomerDetailsRecord()
        {
            ...
            WriteOutGroupBandsToErrorLog();
            WriteToProgresslogIfMinCostAnd4ThRateSamePrice();
        ...
        public static string SetToFourDecimalPlaces(string value)
        {
            ...
            catch (Exception e)
            {
                ...
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                                   "Failed to set price to 4 decimal places:");
        ...
        private static void CheckPricesAreInCorrectFormat()
        {
            ...
            StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                             "CheckPricesAreInCorrectFormat() -- started");
                ...
                else if (tok.ChargingType.ToUpper().Equals(Constants.Pulse))
                {
                    ...
                    if (parsedIntValue / 100 < minimumPulseLength)
                    {
                        StaticVariable.ProgressDetails.Add(Environment.NewLine +
                                                           "ValidateData::CheckPricesAreInCorrectFormat()");
                        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                                           "Pulse: Pulse Length is too short: " +
                                                           tok.CustomerFirstInitialRate);
                        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
            ...
            StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                             "CheckPricesAreInCorrectFormat() -- finished");
        }
        ...
        private static void CheckForDestinationTypes()
        {
            ...
            if (StaticVariable.ExportNdsValue.ToUpper().Equals("TRUE"))
            {
                ...
                if (query.Any())
                {
                    ...
                    {
                        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                                           "The offending destinationan type is - " +
        ...
        private static void CheckTablesForDefaultValue()
        {
            ...
            StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                             "CheckTablesForDefaultValue() -- started");
            ...
            if (extraTablesInTableLinks.Any())
            {
                ...
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "There may be no error. The default prefix may just be different to the table name.");
        ...
        private static void CheckRoundingForIncorrectEntry()
        {
            ...
            try
            {
                ...
                {
                    StaticVariable.ProgressDetails.Add(Environment.NewLine +
                                                       "ValidateData::CheckRoundingForIncorrectEntry()");
        ...
        private static void CheckIfMinCostAndRate4SubseqAreSame()
        {
            ...
            var query =
                ...
                where
                drm.CustomerFourthSubseqRate.Equals(drm.CustomerMinCharge) &&
        ...
        private static void CheckIfFreephoneIsFree()
        {
            ...
            var results =
                ...
                where (db.CustomerPrefixName.ToUpper().Contains("FREE") || db.StdBand.ToUpper().Contains("FREE") ||
                       db.CustomerGroupBand.ToUpper().Contains("FREE") ||
                       db.CustomerGroupBand.ToUpper().Contains("TOLL") ||
        ...
        public static void CheckIntervalLengthsGreaterOrEqualToZero()
        {
            ...
            var queryIntervalLengthValues =
                ...
                select
                new {dr.CustomerInitialIntervalLength, dr.CustomerSubsequentIntervalLength, dr.CustomerPrefixName};
        ...
        public static void CheckAllSchemes()
        {
            ...
            foreach (var tok in query)
            {
                if (!(tok.CustomerAllSchemes.ToUpper().Equals("TRUE")) &&
                    !(tok.CustomerAllSchemes.ToUpper().Equals("FALSE")))
                {
        ...
        public static void CheckTableNames()
        {
            ...
            var queryTableName =
                from DataRecord dr in StaticVariable.CustomerDetailsDataRecord
                where
                !dr.CustomerTableName.Contains(StaticVariable.CountryCodeValue) || !dr.CustomerTableName.Contains("_")
        ...
        private static void CheckForNonMatchingCustomerNames()
        {
            ...
            StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                             "CheckForNonMatchingCustomerNames() -- started");
            List<string> tmpList = new List<string>();
        ...
        private static void CheckForNonUniqueGroupBands() // to remodel
        {
            ...
            StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                             "CheckForNonUniqueGroupBands() -- finished");
        }
                    ...
                    for (int i = 0; i < numberOfTableLinksColumns; i++)
                    {
                        ...
                        if (i.Equals(passPrefix))
                        {
                            if (aryLine[passPrefix].ToUpper().Equals("NO") ||
                                aryLine[passPrefix].ToUpper().Equals("YES")) continue;
                            StaticVariable.ProgressDetails.Add("ValidateData::CheckTableLinksList()");
                            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
        ...
        public static void CheckTimeSchemesList()
        {
            ...
            {
                numberOfTimeSchemes = StaticVariable.TimeSchemes.Count;
                StaticVariable.ProgressDetails.Add(Environment.NewLine + "Time Schemes:");
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                             "Time Scheme Name\tHolidays Relevant\tDefault Rate");
                foreach (string tok in StaticVariable.TimeSchemes)
                {
                    ...
                    StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + aryLine[schemeName].PadRight(19, ' ') +
        ...
        public static void CheckTimeSchemeExceptionsList()
        {
            ...
            StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                             "CheckTimeSchemeExceptionsList() -- started");
            StaticVariable.ProgressDetails.Add(Environment.NewLine + "Time Schemes Exceptions:");
            StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "Time Scheme Name".PadRight(19, ' ') +
            ...
            foreach (string name in StaticVariable.TimeSchemesExceptions)
            {
                ...
                StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + lines[schemeName].PadRight(19, ' ') +
            ...
            foreach (string name in StaticVariable.TimeSchemesNames)
            {
                ...
                if (!bFound)
                {
                    StaticVariable.ProgressDetails.Add(Environment.NewLine + "The time scheme " + name +
            ...
            StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                             "CheckTimeSchemeExceptionsList() -- finished");
        }
        ...
        private static void CheckForMissingDefaultEntries()
        {
            ...
            StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                             "CheckForMissingDefaultEntries() -- started");
        ...
        public static bool CheckForPulseWorksheet()
        {
            ...
            if (WorkSheetsUsed.Any())
            {
                ...
                foreach (var item in WorkSheetsUsed)
                {
                    ...
                    {
                        StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                                           " A pulse worksheet has been detected. If it is not being used, delete worksheet.");
                        found = true;
                    }
                }
            }
        ...
        public static void CheckforAllTariffPlanEntries(string value)
        {
            ...
            StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                             "CheckforAllTariffPlanEntries() -- started");
            ...
            catch (Exception)
            {
                ...
                {
                    StaticVariable.ProgressDetails.Add(Environment.NewLine +
                                                       "ValidateData::CheckforAllTariffPlanEntries()");
                    StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding +
                                                       "Is a pulse rate being used?. If not delete the 'Carrier unit Price' in the header file and the pulse worksheet.");
                }
                else
                {
                    StaticVariable.ProgressDetails.Add(Environment.NewLine +
                                                       "ValidateData::CheckforAllTariffPlanEntries()");
                    StaticVariable.ProgressDetails.Add(Constants.FiveSpacesPadding + "The entry - " + value +
                                                       " is missing in the Tariff Plan header.");
                    ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
                }
            }
            ...
            StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                             "CheckforAllTariffPlanEntries() -- finished");
        ...
        public static void DestinationsAssignedMultipleBands()
      {
         Console.WriteLine("ValidateData".PadRight(30, '.') + "DestinationsAssignedMultipleBands() -- started");
         StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') +
                                          "DestinationsAssignedMultipleBands() -- started");
         ...
         var queryCustomerDetails =
               (from dr in StaticVariable.CustomerDetailsDataRecord
                  select new {dr.StdPrefixName, dr.CustomerPrefixName, dr.StdBand, dr.CustomerUsingCustomerNames})
               .Distinct();
         ...
         foreach (var detail in queryCustomerDetails)
         {
               try
               {
                  errorNames.Add(detail.StdBand.ToUpper(),
                     "Custname - " + detail.CustomerPrefixName + ",\t stdName - " + detail.StdPrefixName +
                     ",\t band - " + detail.StdBand + ",\t UsingCustName - ");
               }
               catch (Exception e)
               {
        ...
        public static void WriteOutGroupBandsToErrorLog()
    {
      ...
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') + "WriteOutGroupBands() -- started");
      StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::WriteOutGroupBands()");
      ...
      {
        StaticVariable.ProgressDetails.Add("ValidateData: WriteOutGroupBands()");
      ...
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') + "WriteOutGroupBands() -- finish");
    }
        public static void WriteToProgresslogIfMinCostAnd4ThRateSamePrice()
    {
    ...
    {
      Console.WriteLine("ValidateData".PadRight(30, '.') + "DestinationsAssignedIncorrectTable() -- started");
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') + "DestinationsAssignedIncorrectTable() -- started");
      ...
      if (query.Any())
      {
        StaticVariable.ProgressDetails.Add(Environment.NewLine + "ValidateData::DestinationsAssignedIncorrectTable()");
      ...
      Console.WriteLine("ValidateData".PadRight(30, '.') + "DestinationsAssignedIncorrectTable() -- finished");
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') + "DestinationsAssignedIncorrectTable() -- finished");
    } 
        ...
        public static void DisplayMissingDetails()
    {
      ...
      DestinationsAssignedIncorrectTable();              
      ...
      StaticVariable.ConsoleOutput.Add("ValidateData".PadRight(30, '.') + "AddMainlandPricesToDependentCountries() -- finished");
        ...
        public static void TestMethod()
        {
            ...
            var query =
                ...
                where pn.PrefixName.ToUpper().Contains("BOSNIA")
                select pn;

            foreach (var var in query)
            {
                StaticVariable.ProgressDetails.Add("Customer Prefix Name : " + var.PrefixName + " - Standard Name : " +
                                                   var.stdPrefixName);
            }
            ErrorProcessing.StopProcessDueToFatalErrorOutputToLog();
